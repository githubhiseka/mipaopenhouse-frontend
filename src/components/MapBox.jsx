const MapBox = ({ top, right, left, title1, title2, subtitle, num, numpos }) => {
	return (
		<div
			className={`absolute w-[23%] h-[6%] z-100 bg-[#FFE37F] bg-opacity-50 border-[#6f2920] border-4 top-[${top}] right-[${right}] left-[${left}] flex flex-col items-center justify-center text-center`}
		>
			<p
