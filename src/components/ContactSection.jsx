...
const ContactSection = () => {
	return (
		<div
			...
			<div className='pt-8'>
				<p className='text-center text-5xl font-extrabold'>GET IN TOUCH</p>
				<p className='text-center text-xl font-medium tracking-wider'>Journey to the Universe of Science</p>
			</div>
			<div className='flex w-full flex-row flex-wrap gap-y-6 px-8 py-8 sm:flex-nowrap md:px-32'>
				...
				<div className='order-2 flex w-1/2 flex-col sm:order-1 sm:w-[35%]'>
					...
					<p className='font-[550]'>Syabil Syuhada</p>
					<p>
						WhatsApp:{' '}
						<a href='https://wa.me/+62816889740' className='underline underline-offset-2'>
							085849340512
						</a>
					</p>
					<p>
						LINE:{' '}
						<a href='https://line.me/ti/p/g5HoF1Mmtv' className='underline underline-offset-2'>
							rrahman.lutfi
						</a>
					</p>
				</div>
