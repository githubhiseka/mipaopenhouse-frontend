...
function UserVerification({ item, setPopup, setConfirmationPopup }) {
	return (
		<div className='flex h-full w-full flex-col'>
			...
			{!item.verified && (
				<div className='flex h-full w-full items-center gap-4 border-t-[1px] border-gray-300/50 bg-gray-200/50 px-8'>
					...
					{/* <button className='flex h-fit items-center justify-between gap-2 rounded-md border-[1px] border-gray-500/50 bg-red-500 px-4 py-1 font-bold text-white'>
						<X size={20} />
						<span>Reject</span>
					</button> */}
				</div>
