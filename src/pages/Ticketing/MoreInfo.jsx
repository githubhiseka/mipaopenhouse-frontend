		...
		<div className='relative flex h-screen w-full items-start justify-center overflow-clip'>
			<div className='flex h-full w-[70%] flex-col items-center justify-start gap-10 py-[10vh] md:w-[70%] md:gap-4'>
				<div>
					...
					<p className='text-center font-lato text-white md:text-2xl text-xl'>
				...
				<div className='z-10 flex h-full w-full flex-col items-center justify-start gap-4 md:items-center md:justify-start md:gap-4'>
					<div className='relative flex h-auto w-full flex-col items-center justify-center gap-2 border-4 border-[#8c5330] bg-[#b69a73] bg-opacity-50 px-4 py-4 font-lato text-white md:w-1/2 md:px-10 md:py-10'>
						<p className='text-center md:text-xl'>
							<span className='md:text-4xl text-2xl font-bold'>Pembayaran Anda sedang dalam proses verifikasi</span>
							<br />
